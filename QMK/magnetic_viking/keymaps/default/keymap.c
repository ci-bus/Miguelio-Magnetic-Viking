...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT_60_tsangan(
        KC_ESC, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_F12,
        _______,   KC_F5,   KC_W,    KC_F6,   _______, _______, _______, KC_F7,   KC_I,    KC_F8,   _______, _______, _______, _______,
        _______,   KC_A,    KC_S,    KC_D,    _______, _______, _______, KC_J,    KC_K,    KC_L,    _______, _______, KC_F9,
        _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_F10,  KC_UP,   KC_F11,
